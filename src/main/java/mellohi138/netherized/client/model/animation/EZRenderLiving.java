package mellohi138.netherized.client.model.animation;
...
public abstract class EZRenderLiving<T extends EntityLiving> extends RenderLivingBase<T> {


    public EZRenderLiving(RenderManager rendermanagerIn, BasicModelEntity modelbaseIn, float shadowsizeIn)
    {

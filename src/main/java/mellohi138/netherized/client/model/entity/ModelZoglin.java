...
import mellohi138.netherized.client.model.animation.*;
import mellohi138.netherized.objects.entity.neutral.EntityZoglin;
import net.minecraft.client.model.ModelBox;
import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.entity.Entity;

public class ModelZoglin extends BasicModelEntity {
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        //
        animator.setAnimation(EntityZoglin.ANIMATION_ATTACK_MELEE);
        //

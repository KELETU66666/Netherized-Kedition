...
public class LayerBruteItem extends LayerHeldItem {
    ...
    private void renderHeldItem(EntityLivingBase p_188358_1_, ItemStack p_188358_2_, ItemCameraTransforms.TransformType p_188358_3_, EnumHandSide handSide)
    {
        if (!p_188358_2_.isEmpty())
        {
            ...
            if(p_188358_1_ instanceof EntityPigmanBrute) {
             if (((EntityPigmanBrute)p_188358_1_).isMeleeAttack()) {
    ...
    {
        ((ModelPigmanBrute)this.livingEntityRenderer.getMainModel()).postRenderArm(0.0625F, p_191361_1_);

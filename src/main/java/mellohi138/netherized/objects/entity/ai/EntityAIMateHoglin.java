...
public class EntityAIMateHoglin extends EntityAIBase {
    private final EntityHoglin animal;
    private final Class <? extends EntityHoglin > mateClass;
    World world;
    private EntityHoglin targetMate;
    int spawnBabyDelay;
    double moveSpeed;

    public EntityAIMateHoglin(EntityHoglin animal, double speedIn)
    {
        this(animal, speedIn, animal.getClass());
    }

    public EntityAIMateHoglin(EntityHoglin p_i47306_1_, double p_i47306_2_, Class <? extends EntityHoglin > p_i47306_4_)
    {
    ...
    private EntityHoglin getNearbyMate()
    {
        List<EntityHoglin> list = this.world.<EntityHoglin>getEntitiesWithinAABB(this.mateClass, this.animal.getEntityBoundingBox().grow(8.0D));
        double d0 = Double.MAX_VALUE;
        EntityHoglin entityanimal = null;

        for (EntityHoglin entityanimal1 : list)
        {

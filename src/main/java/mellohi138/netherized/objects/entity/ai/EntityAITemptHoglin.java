...
import mellohi138.netherized.objects.entity.MobGroundNavigate;
...
public class EntityAITemptHoglin extends EntityAIBase {
    ...
    public EntityAITemptHoglin(EntityCreature temptedEntityIn, double speedIn, Item temptItemIn, boolean scaredByPlayerMovementIn)
    {
        this(temptedEntityIn, speedIn, scaredByPlayerMovementIn, Sets.newHashSet(temptItemIn));
    }

    public EntityAITemptHoglin(EntityCreature temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn, Set<Item> temptItemIn)
    {
        ...
        if (!(temptedEntityIn.getNavigator() instanceof MobGroundNavigate))
        {

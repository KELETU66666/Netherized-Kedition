...
public class EntityTimedAttackZoglin <T extends EntityZoglin & IAttack> extends EntityAIBase {
    ...
    public EntityTimedAttackZoglin(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount) {
        this(entity, moveSpeedAmp, attackCooldown, maxAttackDistance, strafeAmount, 30.0f);
    }

    public EntityTimedAttackZoglin(T entity, double moveSpeedAmp, int attackCooldown, float maxAttackDistance, float strafeAmount, float lookSpeed) {
        this.entity = entity;
